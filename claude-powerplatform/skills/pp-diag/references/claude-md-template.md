...
Coller cette section dans le `CLAUDE.md` du projet Power Apps. Les skills `pp-diag` et `pp-ship` la
lisent pour connaître l'environnement, la solution, le certificat et les connexions. Remplacer les
`<…>` par les valeurs réelles ; supprimer les lignes non applicables.
